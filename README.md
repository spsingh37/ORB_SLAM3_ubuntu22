# Installation guide for ORB-SLAM on Ubuntu 22.04 LTS
...
sudo apt-get install python-dev python3-numpy libtbb2 libtbb-dev libjpeg-dev libpng-dev libtiff-dev libdc1394-dev
